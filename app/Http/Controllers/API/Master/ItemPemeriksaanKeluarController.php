     ...
     public function store(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'kode'               => 'required|string|max:20|unique:item_pemeriksaan_keluars,kode',
    ...
    public function update(Request $request, ItemPemeriksaanKeluar $itemPemeriksaanKeluar)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'kode'              => 'sometimes|required|string|max:20|unique:item_pemeriksaan_keluars,kode,' . $itemPemeriksaanKeluar->id,
