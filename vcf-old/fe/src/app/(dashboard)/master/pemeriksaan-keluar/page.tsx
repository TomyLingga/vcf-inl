...
export default function PemeriksaanKeluarPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.success("Data dihapus", "Item pemeriksaan keluar berhasil dihapus.");
    } catch (err: unknown) {
  ...
  return (
    <div>
      ...
      <ImportConfirmModal
        ...
        onConfirm={async (selectedData) => {
          ...
          const result = await importDataBatch(
            selectedData,
            (data) => masterApi.createItemPemeriksaanKeluar({
        ...
        title="Konfirmasi Import Checklist Keluar"
      ...
      <ImportResultModal
        ...
        title="Hasil Import Checklist Keluar"
      />
    </div>
  );
}